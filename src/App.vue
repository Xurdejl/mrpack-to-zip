...
<template>
  <div class="min-h-screen flex flex-col">
    <main class="container mx-auto px-6 py-8 max-w-2xl flex-grow">
      ...
      <div class="w-full bg-white rounded-lg">
          ...
          <div class="flex gap-2 items-end">
            <div class="flex-grow">
              ...
              <input
                v-model="modrinthUrl"
                type="text"
                class="w-full px-4 py-2 border border-slate-300 rounded-lg outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200"
        ...
        <div class="mt-10 p-4 bg-gray-50 rounded-lg border border-gray-200">
          <div class="flex gap-2">
            <Info class="h-5 w-5 text-gray-700 flex-shrink-0" />
            <div>
